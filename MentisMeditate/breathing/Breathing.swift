...
//    @State private var hideSecondHold = false
    ...
    @State var text = NSLocalizedString("Hello", comment: "")
    @State var index = -1
    var breathing = [NSLocalizedString("Breath in", comment: ""), NSLocalizedString("Hold", comment: ""), NSLocalizedString("Breathe out", comment: ""), NSLocalizedString("Hold", comment: "") ]
                    ...
                    .foregroundColor(.indigo).brightness(-0.05)
                        ...
                        .onReceive(timer) { input in
                            ...
                            if minutes != 45 {
                                ...
                                self.text = NSLocalizedString("You are ready", comment: "")
                            }
                        }
