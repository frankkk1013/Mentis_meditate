    ...
    init(){
        self.tmp = [Schedule(day: NSLocalizedString("day 1", comment: ""),
                    ...
                    Schedule(day: NSLocalizedString("day 2", comment: ""),
                             ...
                             duration: "5 min", description: NSLocalizedString("Meditation can help you sharpen your concentration even if you’re feeling under pressure. Start this exercise to increase your focus as you’re approaching your tasks of the day.", comment: ""),
                    ...
                    Schedule(day: NSLocalizedString("day 4", comment: ""),
                             ...
                             nameAudioFile: "Exawer_monday",
                             duration: "3 min", description: NSLocalizedString("As you’re preparing for your task, you’re suffering from low-see esteem or you just want to focus on it. Do this exercise to boost your self-confidence.", comment: ""),
                             text_eng:["Take a moment to settle your body into a comfortable position"
                    ...
                    Schedule(day: NSLocalizedString("day 5", comment: ""),
                             ...
                             nameAudioFile: "Exawer_monday",
                             duration: "5 min", description: NSLocalizedString("Take a moment to decompress and release your stressful thoughts.", comment: ""),
                    ...
                    Schedule(day: NSLocalizedString("day 6", comment: ""),
                             ...
                             nameAudioFile: "Exawer_monday",
                             duration: "5 min", description: NSLocalizedString("It’s test day. Take some moments to meditate and catch your breath so you’ll be ready, confident and relaxed when you have to perform.", comment: ""),
